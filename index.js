...
function get20s(array){
  ...
  for (let i=0; i<array.length; i++){
    let born= array[i].years.slice(0,4);
    let death= array[i].years.slice(7,11);
    if (parseInt(born) > 1899 && parseInt(death) < 2000){
        the1900People.push(array[i].name);
    }
  }
  return the1900People
}
